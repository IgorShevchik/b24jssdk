...
apt install -y python3 make g++ sqlite3 libsqlite3-dev
...
docker save -o b24js-app.tar b24js-app
```
...
```bash
cd /home/bitrix/b24-js 

# Загрузите образ
docker load -i b24js-app.tar
...
Открыть <https://b24js.bx-shef.by/b24jssdk/>
